...
class WikisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wiki" do
    assert_difference('Wiki.count') do
      post wikis_url, params: { wiki: { body: @wiki.body, private: @wiki.private, title: @wiki.title, user_id: @wiki.user_id } }
    end
  ...
  test "should update wiki" do
    patch wiki_url(@wiki), params: { wiki: { body: @wiki.body, private: @wiki.private, title: @wiki.title, user_id: @wiki.user_id } }
